...
class AgentTurnRequest(BaseModel):
    ...
    last_turn_outcome: List[ExecutedAction] = Field(..., description="Bir önceki turda gerçekleştirilen eylemlerin başarı/hata durumu.")
...
class Action(BaseModel):
    ...
    """
    type: str = Field(..., description="The type of action: 'CLICK', 'TYPE', 'ASK_USER', 'FINISH', 'FAIL'.")
    
    # The key field: the index of the target element in the list the frontend sent.
    target_element_index: Optional[int] = Field(None, description="The index of the target element within the 'visible_elements_html' list.")
